...
def arg_parser():
    ...
    parser.add_argument('-d', '--depth', default=101, type=int, metavar='N',
                        help='depth of resnet (default: 50)', choices=[18, 34, 50, 101, 152])
    parser.add_argument('--dropout', default=0.5, type=float,
                        help='dropout ratio before the final layer')
    parser.add_argument('--groups', default=1, type=int, help='number of frames')
    ...
    parser.add_argument('--without_t_stride', default=True, dest='without_t_stride', action='store_true',
    ...
    parser.add_argument('--pretrained', dest='pretrained', type=str, metavar='PATH',
                        default='./state_dicts/K400-TAM-ResNet-101-f32.pth.tar')
    ...
    parser.add_argument('--datadir', metavar='DIR', help='path to dataset file list',
                         default='/home/SarosijBose/HAR/KDHAR/kinetics400/k400')
    ...
    # logging
    parser.add_argument('--logdir', default='snapshots/', type=str, help='log path')
